...
#         img = cv2.imread("NewPatternFixed.png", 0)
#         raw_points, raw_descrs = self.detect_features(img)
#         points, descs = [], []
#         for kp, desc in zip(raw_points, raw_descrs):
#             points.append(kp)
#             descs.append(desc)
...
#         target = PlanarTarget(image = img, rect=rect, keypoints = raw_points, descrs=raw_descrs, data=None)
